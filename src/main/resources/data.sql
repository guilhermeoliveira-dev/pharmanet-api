...
-- (cpf, data_admissao, email, nome, senha, telefone, endereco_id, expediente, salario, cargo_id, farmacia_id)
-- VALUES('44444444444', '11-11-2014', 'usuario04@gmail.com', 'usuario04 ferreira', '4ferreira', '4444-4444', 4, 'manha', 1050.0, 1, 1);
--
-- INSERT INTO public.funcionario
-- (cpf, data_admissao, email, nome, senha, telefone, endereco_id, expediente, salario, cargo_id, farmacia_id)
-- VALUES('55555555555', '11-11-2014', 'usuario05@gmail.com', 'usuario05 oliveira', '5oliveira', '5555-5555', 5, 'tarde', 2010.0, 2, 2);
--
-- INSERT INTO public.funcionario
-- (cpf, data_admissao, email, nome, senha, telefone, endereco_id, expediente, salario, cargo_id, farmacia_id)
-- VALUES('66666666666', '11-11-2014', 'usuario06@gmail.com', 'usuario06 lopes', '6lopes', '6666-6666', 6, 'manha', 1450.0, 3, 3);
